...
u_newV[0] = interpolate(Expression('std::log(u0 + u1 * exp(-(pow(x[0], 2)+pow(x[1]-x1, 2))/pow(l, 2)))',u0=u0, u1=u1, x1=x1, l=l, degree = 1), V)
u_newV[1] = interpolate(Expression('std::log(u0)', u0=u0, degree = 1), V)
