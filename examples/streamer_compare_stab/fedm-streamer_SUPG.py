...
files.output_folder_path = "./output_SUPG" # Rename output dir from "output" to "output_SUPG"
...
tauwgradv[0] = 0.0*v[0] #*vsupg # E_m**(-1)*(h/(2*mu_y[0]))*mu_y[0]*inner(E, grad(v))
#tauw = interpolate(E_m**(-1)*(h/2)*E, W)
...
while i < number_of_species:
    ...
    if equation_type[i] == 'drift-diffusion-reaction':
